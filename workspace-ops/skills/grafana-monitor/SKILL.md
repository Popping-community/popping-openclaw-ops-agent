...
EC2_SSH_PORT="${EC2_SSH_PORT:?EC2_SSH_PORT is required}"
EC2_SSH_USER="${EC2_SSH_USER:?EC2_SSH_USER is required}"
APP_ACTUATOR_PORT="${APP_ACTUATOR_PORT:?APP_ACTUATOR_PORT is required}"
NODE_EXPORTER_PORT="${NODE_EXPORTER_PORT:?NODE_EXPORTER_PORT is required}"
MYSQL_EXPORTER_PORT="${MYSQL_EXPORTER_PORT:?MYSQL_EXPORTER_PORT is required}"
